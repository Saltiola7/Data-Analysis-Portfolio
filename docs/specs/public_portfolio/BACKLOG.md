...
| PORT-PUB-013 | Build synthetic analytics learning labs and certification evidence | P1 | in_progress | PORT-PUB-009 | learning-lab spec, project, evidence map, README, CI | private-source audit and existing public successors | no | Include requested historical themes without restricted or broken source | L | Five strict Marimo/WASM/browser labs plus provenance and certification gates pass |

## Completed

| id | outcome | completed | commit |
|---|---|---|---|
| PORT-PUB-001 | Clean-root domain and rights boundary established | 2026-07-29 | `0a07de7` |
| PORT-PUB-002 | Synthetic wellness pipeline delivered | 2026-07-29 | `0a07de7` |
| PORT-PUB-003 | Content performance classifier delivered | 2026-07-29 | `0a07de7` |
| PORT-PUB-004 | Public-sector opportunity pipeline delivered | 2026-07-29 | `0a07de7` |
| PORT-PUB-005 | Recruiter and client evidence surface delivered | 2026-07-29 | `0a07de7` |
| PORT-PUB-006 | Reproducible environments and CI delivered | 2026-07-29 | `0a07de7` |
| PORT-PUB-007 | Local release preview prepared | 2026-07-29 | `0a07de7` |
