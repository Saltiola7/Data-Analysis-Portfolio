---
title: Public Engineering Portfolio Changelog
---

# Changelog

## 2026-07-29 - Clean-root domain

- Created empty-history local branch.
- Defined portfolio users, journeys, projects, trust boundary, and release gate.
- Prohibited employer, client, restricted assessment, personal, and
  unknown-license material.
...
## 2026-07-29 - Local release preview

- Completed three clean-room flagships with 127 focused tests.
- Added synthetic-only committed Marimo sessions and stable source-hash checks
  that tolerate volatile UI identifiers.
- Added executed WASM package validation and real-browser interaction journeys.
- Added a responsive recruiter/client landing page, clean-room product links,
  and a fixed-scope DBSCTR service contact.
