...
| CPC-006 | Add certification case-study imputation, benchmark, recall policy, and uncertainty | P0 | completed | CPC-005 | classifier package, app, tests, documentation | Public specification only | Grouped imputation, three-model validation benchmark, frozen recall policy, bootstrap interval, strict Marimo, WASM, and browser journey pass |
...
| CPC-006 | 2026-07-30 | 36 focused tests, Ruff, strict Marimo, deterministic session, executed WASM, and Chromium journey |
